              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="text-center px-4">
                    ...
                    <p className="text-3xl font-bold text-primary">{product.quantity}</p>
                  </div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => openAllotmentModal(product)}
                      className="p-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition shadow-sm"
                      title="Allot"
                    >
              ...
              {isLoadingProducts || isLoadingAllotments ? (
                ...
                <div className="space-y-4">
                  {products.map((product) => {
                    ...
                    const original = remaining + totalAllotted;
                      ...
                      <div key={product.id} className="p-5 bg-gray-50 rounded-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="text-center p-3 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-2xl font-bold text-blue-600">{original}</p>
                          </div>
      ...
      {showResetModal && (
        <div className="fixed inset-0 bg-white/30 backdrop-blur-md flex items-center justify-center p-4 z-50">
          <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scale-in border border-white/20">
            ...
            <p className="text-gray-600 text-center mb-6">
              This will restore all product quantities and clear all allotments for the day. This action cannot be undone.
            </p>
